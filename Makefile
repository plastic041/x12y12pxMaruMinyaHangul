...
SRC_FILE = src/x12y12pxMaruMinyaHangul.kbitx

TTF_FILE = $(FONTS_DIR)/x12y12pxMaruMinyaHangul.ttf
BDF_FILE = $(FONTS_DIR)/x12y12pxMaruMinyaHangul.bdf
WOFF2_FILE = $(FONTS_DIR)/x12y12pxMaruMinyaHangul.woff2
